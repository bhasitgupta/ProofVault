...
class PolygonLedgerAdapter:
    ...
    def __init__(
        ...
        self.evidence_contract_addr = evidence_registry_address or os.getenv("POLYGON_EVIDENCE_REGISTRY_ADDRESS")
        self.provenance_contract_addr = provenance_registry_address or os.getenv("POLYGON_PROVENANCE_REGISTRY_ADDRESS")
