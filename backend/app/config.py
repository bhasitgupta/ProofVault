...
class Settings(BaseSettings):
    ...
    POLYGON_EVIDENCE_REGISTRY_ADDRESS: str = "0xF022e8E8E7FD5d565fAb24dC74B6fAc1c8760a01"
    POLYGON_PROVENANCE_REGISTRY_ADDRESS: str = "0x11A0a778303196d735B9cCdE62eB5bC5B29a855a"
