  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <div className="md:col-span-8 p-8 rounded-3xl glass-ivory border-crimson-gold shadow-xl relative overflow-hidden flex flex-col justify-between bg-white/90">
          <div className="space-y-3 relative z-10">
            <div className="flex items-center gap-2.5">
              <span className="px-3 py-1 rounded-full text-[10px] font-mono font-extrabold bg-crimson-50 text-crimson-800 border border-crimson-200 flex items-center gap-1.5">
                <Scale className="w-3 h-3 text-mahogany-700" />
                SOVEREIGN EVIDENCE VAULT
              </span>
              <span className="text-xs text-stone-400">•</span>
              <span className="text-xs text-mahogany-900 font-mono font-bold flex items-center gap-1">
                <Activity className="w-3 h-3 text-crimson-600" /> ZERO-TRUST CLEARANCE ENFORCED
              </span>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-6 mt-6 border-t border-stone-200 relative z-10 font-mono">
            <div>
              ...
              <div className="text-2xl font-black text-crimson-900 mt-0.5">{cases.length}</div>
            </div>
            <div>
              <div className="text-[10px] text-stone-500 uppercase tracking-wider font-bold">SEALED EVIDENCE</div>
              <div className="text-2xl font-black text-mahogany-800 mt-0.5">{totalDocs} <span className="text-xs text-stone-400">docs</span></div>
            </div>
            <div>
        ...
        <div className="md:col-span-4 p-6 rounded-3xl glass-ivory border border-mahogany-900/15 shadow-xl flex flex-col justify-between space-y-4 bg-white/80">
          <div className="space-y-1.5">
            <div className="text-xs font-mono font-bold text-stone-800 uppercase tracking-wider flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-crimson-700" /> Security Perimeter
            </div>
          ...
          <div className="space-y-2 font-mono text-xs">
            <div className="p-3 rounded-2xl bg-parchment-100 border border-stone-200 flex items-center justify-between">
              <span className="text-stone-600 font-medium">TRUST ANCHOR</span>
              <span className="text-crimson-900 font-bold flex items-center gap-1">
                <CheckCircle2 className="w-3.5 h-3.5 text-amber-700" /> POLYGON AMOY
              </span>
            </div>
            <div className="p-3 rounded-2xl bg-parchment-100 border border-stone-200 flex items-center justify-between">
              <span className="text-stone-600 font-medium">KEY CUSTODY</span>
              <span className="text-crimson-900 font-bold">VAULT TRANSIT</span>
            </div>
            <div className="p-3 rounded-2xl bg-parchment-100 border border-stone-200 flex items-center justify-between">
              <span className="text-stone-600 font-medium">BSA CERTIFICATE</span>
              <span className="text-mahogany-800 font-bold">BSA §63 / IEA §65B</span>
            </div>
          </div>
      ...
      {error && (
        <div className="p-4 bg-rose-50 border border-rose-200 rounded-2xl text-xs text-rose-800 shadow-md">
          {error}
        </div>
      )}
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-24 space-y-4">
          <div className="w-10 h-10 rounded-full border-2 border-crimson-700 border-t-transparent animate-spin"></div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-black text-stone-900 tracking-tight flex items-center gap-2 font-serif-judicial">
              <Folder className="w-4 h-4 text-crimson-800" />
              ...
              return (
                ...
                >
                  <div className="space-y-3.5 relative z-10">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-xs font-black text-crimson-900 bg-crimson-50 px-3 py-1 rounded-xl border border-crimson-200">
                        {c.case_id}
                      </span>
                    ...
                    <div>
                      <h3 className="font-serif-judicial text-base font-bold text-stone-900 group-hover:text-crimson-800 transition-colors line-clamp-1">
                        {c.title}
                      </h3>
                  ...
                  <div className="space-y-4 pt-4 border-t border-stone-100 relative z-10">
                    <div className="flex items-center justify-between text-xs font-mono text-stone-600">
                      ...
                      <span className="flex items-center gap-1 text-stone-600">
                        <Layers className="w-3.5 h-3.5 text-mahogany-700" />
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <button
                        ...
                        className="flex flex-col items-center justify-center gap-1 py-2.5 px-1 bg-stone-50 hover:bg-crimson-50 border border-stone-200 hover:border-crimson-200 text-stone-700 hover:text-crimson-900 text-[10px] rounded-2xl font-bold transition-all shadow-sm cursor-pointer"
                        title="Open Evidence Vault"
                      >
                        <FileText className="w-4 h-4 text-crimson-700" />
                        <span>Files</span>
                      </button>
                      <button
      ...
      <div className="glass-ivory rounded-2xl p-4 border border-stone-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono text-stone-600 bg-white/90">
        ...
        <div className="flex items-center gap-2 text-crimson-800 font-bold">
