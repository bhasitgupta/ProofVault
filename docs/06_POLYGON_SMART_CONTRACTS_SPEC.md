...
In strict accordance with SIH26190 Technical Requirements Document (`TRD(2).md §12.1 & §13`) and Software Requirements Specification (`SRS(2).md §6.6`), the trust layer consists of **two** authoritative smart contracts:
